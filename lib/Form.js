...
function (_React$Component) {
  ...
  _proto.cleanError = function cleanError(name) {
    ...
    this.setState({
      formError: (0, _extends8.default)({}, formError, (_extends2 = {}, _extends2[name] = null, _extends2))
    });
  };
  ...
  _proto.setError = function setError(name, message) {
    ...
    var formError = this.state.formError;
    this.setState({
      formError: (0, _extends8.default)({}, formError, (_extends3 = {}, _extends3[name] = message, _extends3))
    });
  };
  ...
  _proto.setErrors = function setErrors(errors) {
    var formError = this.state.formError;
    this.setState((0, _extends8.default)({}, formError, {}, errors));
  };
  ...
  _proto.validateField = function validateField(name, callback, triggerType) {
    ...
    var asyncTimer = setTimeout(function () {
      ...
      _this2.setState({
        validatingFields: (0, _extends8.default)({}, validatingFields, (_extends4 = {}, _extends4[name] = true, _extends4)),
        formError: (0, _extends8.default)({}, formError, (_extends5 = {}, _extends5[name] = null, _extends5))
      });
    }, asyncTestDelay);
    ...
    this._validateField(name, function (errors, value) {
      ...
      _this2.setState({
        formError: (0, _extends8.default)({}, formError, (_extends6 = {}, _extends6[name] = errors ? errors[0].message : null, _extends6)),
        validatingFields: (0, _extends8.default)({}, validatingFields, (_extends7 = {}, _extends7[name] = false, _extends7))
      }, function () {
        callback(errors, value);
      });
    }, triggerType);
...
Form.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  disableValidator: _propTypes.default.func,
