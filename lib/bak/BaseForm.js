...
var propTypes = {
  ...
  formComponent: _propTypes.default.elementType
};

var BaseForm =
/*#__PURE__*/
function (_React$Component) {
  (0, _inherits2.default)(BaseForm, _React$Component);
  ...
  function BaseForm() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(BaseForm)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(BaseForm, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          FormComponent = _this$props2.formComponent,
          others = (0, _objectWithoutProperties2.default)(_this$props2, ["formComponent"]);
      var formProps = (0, _omit.default)(others, (0, _keys.default)(propTypes));
      return _react.default.createElement(_FormContext.default.Provider, {
        value: this.getFormContext()
      }, _react.default.createElement(FormComponent, (0, _extends2.default)({}, formProps, {
        form: this
      })));
    }
  }], [{
...
(0, _defineProperty2.default)(BaseForm, "propTypes", propTypes);
(0, _defineProperty2.default)(BaseForm, "defaultProps", {
  path2obj: true,
  rules: {}
});