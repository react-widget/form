...
function (_React$Component) {
  ...
  (0, _createClass2.default)(FormItem, [{
    ...
    value: function render() {
      ...
      var getFormItemInputProps = form.props.getInputProps || function () {
        return {};
      };
      ...
      var InputComponent = _react.default.cloneElement(children, _objectSpread({}, getFormItemInputProps(name), {
        value: this.getValue(),
...
(0, _defineProperty2.default)(FormItem, "propTypes", {
  ...
  style: _propTypes.default.object //extra: PropTypes.node,
